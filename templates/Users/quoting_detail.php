                                    ...
                                    <form action="#" class="form-inline">
                                        <table class="table table-bordered align-middle">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="mgu-logo">
                                                        <img src="assets/images/logod.svg" style="width: 130px;border-radius: 0;" alt="Prodigy Health Insurance" class="mr-2 d-inline-block align-middle">
                        ...
                        <div class="tab-pane fade" id="quotes" role="tabpanel" aria-labelledby="quotes-tab">
                            <div class="row">
                                <div class="col-md-6 d-flex align-items-stretch">
                                    <div class="panel">
                                        <div class="panel-heading panel-heading-divider"> <a href="edit-group.html" class="btn btn-rounded btn-danger btn-sm float-right" style="float: right;">Edit Group</a> <span class="panel-title"><i class="link-icon icon-md" data-feather="users"></i> Group Information</span> </div>
                                        <div class="panel-body">
                                            <dl class="row">
                                                <dt class="col-sm-4 text-right">Group Information</dt>
                                                <dd class="col-sm-8"> <strong> <a href="#">St. Joseph Montessori School</a> </strong>
                                                    <address class="address-summary ">
                                                        933 Hamlet Street<br>
                                                        Columbus, OH 43201
                                                    </address>
                                                </dd>
                                                <dt class="col-sm-4 text-right">Business Classification</dt>
                                                <dd class="col-sm-8">Elementary and Secondary Schools (611110) / Elementary and Secondary Schools (8211) </dd>
                                            </dl>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <dl class="row">
                                                ...
                                                <dd class="col-sm-8">Youngs Mgmt</dd>
                                                ...
                                                <dd class="col-sm-8"><a href="mailto:John@youngsmgmt.com">John@youngsmgmt.com</a></dd>
                                                <dt class="col-sm-4 text-right">Request Created</dt>
                                                <dd class="col-sm-8">Jun 30, 2025 (5:40pm) by John Youngs</dd>
                                            </dl>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body">
                                            <div class="alert alert-secondary">
                                                <div class="icon"><span class="s7-info"></span></div>
                                                <div class="message"> <strong>No Notes: </strong> There were no notes included in this quote request. </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="alert alert-info">
                                                <div class="message"> <i class="link-icon icon-md" data-feather="dollar-sign"></i> <strong>None entered: </strong>No claims experience was entered. </div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading panel-heading-divider">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 text-right"> <a href="#" class="btn btn-rounded btn-secondary mr-1 d-print-none">Upload Files</a> <a href="#" class="btn btn-rounded btn-primary d-print-none" data-no-ajax="1">Download All</a> </div>
                                                </div>
                                            </div>
                                            <div class="panel-body">
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td> Jun 30, 2025 (5:40pm) </td>
                                                            <td><a href="#">Census St Joseph Motesorri.xlsx</a> (13.69 KB)
                                                                71 Member(s) </td>
                                                            <td class=""> Census </td>
                                                            <td class="text-right text-nowrap">
                                                                <a href="#" data-no-ajax="1" class="btn btn-xs btn-secondary btn-rounded mr-2 d-print-none"><i class="link-icon icon-md" data-feather="download"></i> Download</a>
