                ...
                <?php if ($this->request->getSession()->read('RitevetUsers.id') == $request->sender_user->id) : ?>
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="card" style="height: 314.617px;">
                            ...
                            ?>
                            <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'sentappointmentsdetail', $request->id]) ?>" target="_blank">
                                ...
                                <?php else : ?>
                                    <p class="card-text font-medium-1 text-center mb-0">
                                        ...
                                        if (!empty($request->multi_date)) {
                                            ...
                                            $formattedDates = array_map('trim', array_map(fn($date) => date("F jS, Y", strtotime($date)), $dates));
                            ...
                            <div class="card-footer mx-auto text-center">
                                <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'sentappointmentsdetail', $request->id]) ?>" target="_blank" class="btn btn-outline-danger btn-sm">See details -->>></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
