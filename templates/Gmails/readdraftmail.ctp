...
<div class="add-charity-container">
    ...
    <div class="white-bg">
        ...
        <div id="message_box_title">
			<?php echo $this->Form->create('Gmail', array('name' => 'writemail','controller' => 'gmails','id'=>'form_draftmail','action' => 'readdraftmail/'.$mails->id, 'onSubmit'=>'return validate(this)'));?>
			<?php echo $this->Form->hidden('id',['value' => $mails->id]);?>
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td align="left" valign="top"><label>
					<?php echo $this->Form->text('subject', array('id'=>'subject','class'=>'mail_field', 'value'=> $mails->subject)); ?>
				...
				<tr>
					...
					<td align="left" valign="top">
						<?=$this->Form->textarea('message', array('cols'=>'60','rows'=>'3', 'id'=>'editor1', 'value'=> $mails->message));?>
