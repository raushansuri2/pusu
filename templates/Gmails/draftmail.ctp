    ...
    <div class="white-bg">
        ...
        <div class="row" id="message_main_box_right">
                ...
                <ul>
                    ...
                    <li><?php echo $this->Html->link('Draft', array('controller'=>'gmails', 'action' => 'draftmail'), array('escape' => false, 'class'=>'active')); ?></li>
                </ul>
                    ...
                    ?>
                        <tr>
                          <td align="left" valign="top" class="message_text message_text_new"><label>
                            <?php echo $this->Html->link(__($firstname,true), array('controller'=>'gmails', 'action' => 'readdraftmail', $maillist->id), array('escape' => false, 'class'=>'link_txt')); ?>
                          </label>
                          </td>
                          <td align="left" valign="top" class="message_text message_text_new">
                                <?php echo $this->Html->link(__($subject,true), array('controller'=>'gmails', 'action' => 'readdraftmail', $maillist->id), array('escape' => false, 'class'=>'link_txt')); ?>
                          </td>
                          <td align="left" valign="top" class="message_text message_text_new">
                            <?php $dt=date('F d, Y H:i:s',$date); ?>
                                <?php echo $this->Html->link(__($dt,true), array('controller'=>'gmails', 'action' => 'readdraftmail', $maillist->id), array('escape' => false, 'class'=>'link_txt')); ?>
                          </td>
                        </tr>
                        <?php
                        }
