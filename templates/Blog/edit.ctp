            ...
            <div class="row mrg-r-10 mrg-l-10">
                        ...
                        <div class="col-sm-6">
                        <label>Image-1</label>
																								<?php $IMG1 = ($freestaffs->image_1 !='') ? $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->image_1 : $this->Url->build('/').'img/dummy.jpg'; ?>
                        <img src="<?php echo $IMG1;?>" class="img-responsive" alt="Berry Lace Dress" width="75">
																								<?php echo $this->Form->input('image_1', ['class' => '','type'=>'file', 'required'=>false,'placeholder' => '', 'div' => false, 'label' => false]); ?>
                        </div>
                        <div class="col-sm-6">
                        <label>Image-2</label>
																								<?php $IMG2 = ($freestaffs->image_2 !='') ? $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->image_2 : $this->Url->build('/').'img/dummy.jpg'; ?>
                        <img src="<?php echo $IMG2;?>" class="img-responsive" alt="Berry Lace Dress" width="75">
                        <?php echo $this->Form->input('image_2', ['class' => '','type'=>'file', 'required'=>false,'placeholder' => '', 'div' => false, 'label' => false]); ?>
                        </div>
                        <div class="col-sm-6">
                        <label>Image-3</label>
																								<?php $IMG3 = ($freestaffs->image_3 !='') ? $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->image_3 : $this->Url->build('/').'img/dummy.jpg'; ?>
                        <img src="<?php echo $IMG3;?>" class="img-responsive" alt="Berry Lace Dress" width="75">
                        <?php echo $this->Form->input('image_3', ['class' => '','type'=>'file', 'required'=>false,'placeholder' => '', 'div' => false, 'label' => false]); ?>
                        </div>
                        <div class="col-sm-6">
                        <label>Image-4</label>
																								<?php $IMG4 = ($freestaffs->image_4 !='') ? $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->image_4 : $this->Url->build('/').'img/dummy.jpg'; ?>
                        <img src="<?php echo $IMG4;?>" class="img-responsive" alt="Berry Lace Dress" width="75">
                        <?php echo $this->Form->input('image_4', ['class' => '','type'=>'file', 'required'=>false,'placeholder' => '', 'div' => false, 'label' => false]); ?>
                        </div>
                        <div class="col-sm-6">
                        <label>Image-5</label>
																								<?php $IMG5 = ($freestaffs->image_5 !='') ? $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->image_5 : $this->Url->build('/').'img/dummy.jpg'; ?>
                        <img src="<?php echo $IMG5;?>" class="img-responsive" alt="Berry Lace Dress" width="75">
                        <?php echo $this->Form->input('image_5', ['class' => '','type'=>'file', 'required'=>false,'placeholder' => '', 'div' => false, 'label' => false]); ?>
                        </div>
                        <div class="col-sm-6">
                        <label>Video</label>
																								<?php if($freestaffs->video !=''){ ?>
                        <a href="<?php echo $this->Url->build('/').'img/uploads/freestaff/'.$freestaffs->video;?>" target="_blank">View Video</a>
																								<?php } ?>
