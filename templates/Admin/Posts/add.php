    ...
    <div class="mainpanel">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li><?= $this->Html->link('Manage Posts', ['controller' => 'Posts', 'action' => 'index']); ?></li>
                        <li>Add Post</li>
                    </ul>
                    <h4>Add Post</h4>
                </div>
        ...
        <div class="contentpanel">
            <div class="row">
                ...
                <?php echo $this->Form->create($posts, ['type' => 'file', 'novalidate' => 'novalidate']); ?>
                
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h4 class="panel-title">Add Post</h4>
                        <p>Please provide all below details to add post.</p>
                    </div><!-- panel-heading -->
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Post Question <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Post Answer</label>
                                <div class="col-sm-9">
