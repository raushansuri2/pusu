                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <span class="sort-link">
                                    <?= $this->Paginator->sort('postTitle', $this->Html->image('sort-arrow-top.png', ['alt' => 'Ascending', 'title' => 'Ascending']), ['escape' => false, 'direction' => 'asc', 'lock' => true]); ?>
                                    <?= $this->Paginator->sort('postTitle', $this->Html->image('sort-arrow-bottom.png', ['alt' => 'Descending', 'title' => 'Descending']), ['escape' => false, 'direction' => 'desc', 'lock' => true]); ?>
                                </span>
                            </th>
                            <th>Posted By</th>
                            <th>Total Like</th>
                        ...
                        <?php if (count($posts)): ?>
                            <?php foreach ($posts as $post): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo $this->Url->build(['controller'=>'Likes','action'=>'index',$post->id]);?>" title="click to view like list" ><?= h($post->totalLike); ?></a></td>
                                    <td><a href="<?php echo $this->Url->build(['controller'=>'Comments','action'=>'index',$post->id]);?>" title="click to view comment list"><?= h($post->totalComment); ?></a></td>
