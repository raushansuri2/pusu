    ...
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            <div class="row">
                ...
                <?php echo $this->Form->create($comments, ['type' => 'file', 'novalidate' => 'novalidate']); ?>
                
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h4 class="panel-title">Edit Comment</h4>
                        <p>Please provide all below details to edit comment.</p>
                    </div><!-- panel-heading -->
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Comment Question <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Comment Answer</label>
                                <div class="col-sm-9">
