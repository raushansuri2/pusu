        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="search-body">
                    <a href="<?php echo $this->Url->build(['controller' => 'Elearning', 'action' => 'showVideos']);?>" class="btn btn-primary mr5 ml10">Back</a>                    
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9"><?php echo $details->id; ?></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9"><?php echo wordwrap($details->description, 100, "<br>", true); ?></div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-sm-2"><strong>URL : </strong></label>
                                <div class="col-sm-9">
                                    <a href="<?php echo h($details->url); ?>" target="_blank"><?php echo h($details->url); ?></a>
                                </div>
                            </div>
