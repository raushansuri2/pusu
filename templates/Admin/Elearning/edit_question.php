    ...
    <div class="mainpanel">
        ...
        <div class="contentpanel">
            <div class="row">
                ...
                <?php echo $this->Form->create($question); // Assuming $question is the entity being edited ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        echo $this->Form->input('category_id', [
                                            'type' => 'select',
                                            'options' => $categories, // Assuming $categories is passed to the view
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <?php echo $this->Form->submit('Update Question', ['class' => 'btn btn-primary mr5', 'div' => false, 'label' => false]); ?>
                            </div>
                        </div>
                    </div><!-- panel-footer -->  
                </div><!-- panel -->
