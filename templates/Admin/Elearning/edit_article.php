                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php echo $this->Form->input('title', [
                                            ...
                                            'value' => h($article->title) // Populate with existing title
                                        ]); ?>
                                    </div>
                                </div>
                            </div><!-- col-sm-6 -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <?php echo $this->Form->input('content', [
                                            ...
                                            'value' => h($article->content) // Populate with existing content
                                        ]); ?>
                                    </div>
                                </div>
                            </div><!-- col-sm-6 -->
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div id="imagePreview" style="margin-top: 10px;">
                                            <?php if (!empty($article->image)): ?>
                                                <img id="previewImg" src="<?= $this->Url->build('/img/uploads/elearning_articles/' . $article->image); ?>" alt="Image Preview" style="max-width: 150px; height: 150px;" />
                                            <?php else: ?>
