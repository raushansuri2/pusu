<div class="mainwrapper">
    ...
    <div class="mainpanel">
        ...
        <div class="contentpanel">      
            ...
            <?php echo $this->Form->create($state, ['url' => ['controller' => 'Locations', 'action' => 'editState', $state->id], 'type' => 'post']); ?>
            ...
            <div class="form-group">
                ...
                <?php
                echo $this->Form->control('state_tax', [
                    'class' => 'form-control', 
            ...
            <div class="form-group">
                <?php echo $this->Form->button(__('Update State'), ['class' => 'btn btn-primary']); ?>
            </div>
