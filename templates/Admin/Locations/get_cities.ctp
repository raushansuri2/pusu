        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="search-body" style="width: 39%;">
                    <a href="<?php echo $this->Url->build(['controller' => 'Locations', 'action' => 'addCity']);?>" class="btn btn-primary mr5 ml10" style="float: right;">Add City</a>
                    <?php 
                        echo $this->Form->create('Cities',  ['type' => 'get', 'novalidate' => 'novalidate']);
        ...
        <div class="contentpanel">      
                        ...
                        if(count($cities)){
                            foreach ($cities as $city):
                                ...
                                <tr>
                                    ...
                                    <td><?php echo h($city->state->country->name); ?></td> 
                                    <td class="table-action" style="width: 10%;">
                                        <a href="<?php echo $this->Url->build(['controller' => 'Locations', 'action' => 'editCity', $city->id]);?>" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a>
                                        <a href="<?php echo $this->Url->build(['controller' => 'Locations', 'action' => 'deleteCity', $city->id]);?>" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this city?')" title="Delete" class="delete-row tooltips"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                                <?php
                                $i++;
            ...
            <div class="paging-container">
                ...
                if($this->Paginator->counter(array('format' => __('{{count}}'))) !=0) {?> 
                    <p>
                        <?php
                        echo $this->Paginator->counter(array('format' => __('<p class="records-showing">Showing {{start}} - {{end}} of {{count}} Cities</p>'))); // Change from States to Cities
                        ?>
                    </p>
