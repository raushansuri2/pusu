        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="search-body" style="width: 39%;">
                    <!-- <?=$this->Html->link('Add', ['controller' => 'Pages', 'action' => 'add'], ['class' => 'btn btn-primary mr5 ml10', 'style' => 'float: right;']); ?> -->
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <span class="sort-link">
                                    <?= $this->Paginator->sort('page_title', $this->Html->image('sort-arrow-top.png', ['alt' => 'Ascending', 'title' => 'Ascending']), ['escape' => false, 'direction' => 'asc', 'lock' => true]); ?>
                                    <?= $this->Paginator->sort('page_title', $this->Html->image('sort-arrow-bottom.png', ['alt' => 'Descending', 'title' => 'Descending']), ['escape' => false, 'direction' => 'desc', 'lock' => true]); ?>
                                </span>
                            </th>
                            <th>
                                Created
                        ...
                        <?php if (count($pages)): ?>
                            <?php foreach ($pages as $page): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?= $page->status == '1' ? 
                                            $this->Html->link('Active', ['controller' => 'Pages', 'action' => 'status', $page->id], ['onclick' => "return confirm('Are you sure want to deactivate this page?')"]) : 
                                            $this->Html->link('Inactive', ['controller' => 'Pages', 'action' => 'status', $page->id], ['onclick' => "return confirm('Are you sure want to activate this page?')"]); ?>
                                    </td>
                                    <td class="table-action" style="width: 10%;">
                                        <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'Pages', 'action' => 'edit', $page->id], ['data-toggle' => 'tooltip', 'title' => 'Edit', 'class' => 'tooltips', 'escape' => false]); ?>
                                        <?= $this->Html->link('<i class="fa fa-trash-o"></i>', ['controller' => 'Pages', 'action' => 'delete', $page->id], ['data-toggle' => 'tooltip', 'onclick' => "return confirm('Are you sure you want to delete this page?')", 'title' => 'Delete', 'class' => 'delete-row tooltips', 'escape' => false]); ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
