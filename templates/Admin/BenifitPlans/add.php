            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li>Add Benefit Plan</li>
                    </ul>
                    <h4>Add Benefit Plan</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Add Benefit Plan</h4>
                        <p>Please provide all below details to add benefit plan.</p>
                    </div><!-- panel-heading -->
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <?php echo $this->Form->submit('Add Benefit Plan', ['class' => 'btn btn-primary mr5', 'div' => false, 'label' => false]); ?>
