            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li>Add Loose Plan</li>
                    </ul>
                    <h4>Add Loose Plan</h4>
                </div>
            </div><!-- media -->
        </div><!-- pageheader -->
            ...
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Add Loose Plan</h4>
                        <p>Please provide all below details to add loose plan.</p>
                    </div><!-- panel-heading -->
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-9 col-sm-offset-3">
                                <?php echo $this->Form->submit('Add Loose Plan', ['class' => 'btn btn-primary mr5', 'div' => false, 'label' => false]); ?>
