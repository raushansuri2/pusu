    ...
    <div class="mainpanel">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li><?= $this->Html->link('Manage Likes', ['controller' => 'Likes', 'action' => 'index']); ?></li>
                        <li>Edit Like</li>
                    </ul>
                    <h4>Edit Like</h4>
                </div>
        ...
        <div class="contentpanel">
            <div class="row">
                ...
                <?php echo $this->Form->create($likes, ['type' => 'file', 'novalidate' => 'novalidate']); ?>
                
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h4 class="panel-title">Edit Like</h4>
                        <p>Please provide all below details to edit like.</p>
                    </div><!-- panel-heading -->
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Like Question <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Like Answer</label>
                                <div class="col-sm-9">
