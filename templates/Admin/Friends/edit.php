    ...
    <div class="mainpanel">
            ...
            <div class="media">
                ...
                <div class="media-body">
                    <ul class="breadcrumb">
                        ...
                        <li><?= $this->Html->link('Manage Friends', ['controller' => 'Friends', 'action' => 'index']); ?></li>
                        <li>Edit Friend</li>
                    </ul>
                    <h4>Edit Friend</h4>
                </div>
        ...
        <div class="contentpanel">
            <div class="row">
                ...
                <?php echo $this->Form->create($friends, ['type' => 'file', 'novalidate' => 'novalidate']); ?>
                
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h4 class="panel-title">Edit Friend</h4>
                        <p>Please provide all below details to edit friend.</p>
                    </div><!-- panel-heading -->
                    <div class="panel-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Friend Question <span class="asterisk">*</span></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Friend Answer</label>
                                <div class="col-sm-9">
