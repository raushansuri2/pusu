        ...
        <div class="pageheader">
            <div class="media">
                ...
                <div class="search-body" style="width: 39%;">
                    <?//= $this->Html->link('Add', ['controller' => 'Notifications', 'action' => 'add'], ['class' => 'btn btn-primary mr5 ml10', 'style' => 'float: right;']); ?>
                        ...
                        <?php if (count($notifications)): ?>
                            <?php foreach ($notifications as $notification): ?>
                                <tr>
                                    ...
                                    <td><a href="<?php echo $this->Url->build(['controller'=>'Users','action'=>'userdetails',$notification->userId]);?>" title="click to view user details"><?= h($notification->user->firstName); ?></a></td>
                                   <td><?= h($notification->message); ?></td>
                                    <td><?= h($notification->created); ?></td>
                                    
                                    <td class="table-action" style="width: 10%;">
                                        <!-- <a href="<?= $this->Url->build(['controller' => 'Notifications', 'action' => 'details', $notification->id]) ?>" 
                                           data-toggle=" tooltip" title="Details" class="tooltips"><i class="fa fa-eye"></i></a> -->
                                        <!-- <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['controller' => 'Notifications', 'action' => 'edit', $notification->id], ['data-toggle' => 'tooltip', 'title' => 'Edit', 'class' => 'tooltips', 'escape' => false]); ?> -->
                                        <?= $this->Html->link('<i class="fa fa-trash-o"></i>', ['controller' => 'Notifications', 'action' => 'delete', $notification->id], ['data-toggle' => 'tooltip', 'onclick' => "return confirm('Are you sure you want to delete this notification?')", 'title' => 'Delete', 'class' => 'delete-row tooltips', 'escape' => false]); ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
